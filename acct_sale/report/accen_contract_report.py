...
class AccenContractReport(models.AbstractModel):
    _name = 'report.acct_sale.accten_report_contract'
    ...
    def _get_total(self,docids,data=None):
        ...
        res = {}
        # a = {}
        for sale_model in sale.browse(docids):
    ...
    def _get_report_values(self,docids,data=None):
        ...
        report = report_obj._get_report_from_name('acct_sale.accten_report_contract')
