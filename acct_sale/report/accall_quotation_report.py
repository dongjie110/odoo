...
class AccallQuotationReport(models.AbstractModel):
    _name = 'report.acct_sale.acctall_report_quotation'
    ...
    def _get_report_values(self,docids,data=None):
        ...
        report = report_obj._get_report_from_name('acct_sale.acctall_report_quotation')
